...
const ErrorPage = () => {
  ...
  return (
    <main className="flex h-screen w-screen items-center justify-center p-10">
      <article className="flex h-screen w-screen items-center bg-gray-100">
        <div className="container flex flex-col items-center justify-center px-5 text-gray-700 md:flex-row">
          <section className=" max-w-md">
            <div className="font-dark p-1 text-5xl font-bold">404</div>
            <span className="bold text-2xl uppercase">{error.statusText}</span>
            <p className="p-1 text-2xl font-light leading-normal md:text-3xl">Sorry we couldn&apos;t find this page.</p>
            <p className="mb-8">But dont worry, you can find plenty of other things on our homepage.</p>
            <ButtonOrLink
              href="/"
              className="bg-brand-700 hover:bg-brand-800 focus:ring-brand-300 dark:focus:ring-brand-900 mr-3 inline-flex items-center justify-center rounded-lg px-5 py-3 text-center text-base font-medium text-white focus:ring-4"
            >
              <svg
